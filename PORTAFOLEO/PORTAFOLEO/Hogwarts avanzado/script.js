...
const informacionPrincipal = () => {
  ...
  if (familia.value != "") {
      ...
      familia.classList.remove("is-valid");
  }

  if (linaje.value != "") {
      linaje.classList.add("is-valid");
      linaje.classList.remove("is-invalid");
  }
  else {
      linaje.classList.add("is-invalid");
      linaje.classList.remove("is-valid");
  }

  if (cualidades.value != "") {
      cualidades.classList.add("is-valid");
      cualidades.classList.remove("is-invalid");
  }
  else {
      cualidades.classList.add("is-invalid");
      cualidades.classList.remove("is-valid");
  }
};
